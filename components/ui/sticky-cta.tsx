  ...
  return (
    ...
    >
      <Link href="/contact" className="flex-1">
        <Button variant="outline" className="w-full h-12 rounded-xl text-foreground font-semibold" as="div">
          Free Advice
        </Button>
      </Link>
      <Link href="/#apply" className="flex-1">
        <Button className="w-full h-12 rounded-xl bg-primary text-white font-bold shadow-soft" as="div">
          Apply Now
        </Button>
      </Link>
    </motion.div>
